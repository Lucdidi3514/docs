...
description: 'Installez et lancez Kit'Asso en local en 10 minutes'
---

## Prérequis

<Check>**Node.js 18+** installé ([Télécharger](https://nodejs.org))</Check>
<Check>**npm** ou **yarn** installé</Check>
<Check>**Compte Supabase** créé ([S'inscrire](https://supabase.com))</Check>
...
<Steps>
  ...
  <Step title="Installer les dépendances">
    ...
    **Dépendances principales :**
    ...
    <Tip>L'installation prend environ 2-3 minutes</Tip>
  </Step>
