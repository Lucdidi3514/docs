...
description: "Plateforme pour la transformation numérique des associations françaises"
---
...
Kit'Asso est une plateforme complète qui aide les associations françaises à découvrir, comparer et adopter les meilleurs outils numériques adaptés à leurs besoins.
...
<CardGroup cols={2}>
  <Card title="GitHub Issues" icon="github" href="https://github.com/votre-org/kitasso/issues">
    Signaler un bug ou proposer une feature
  </Card>
  <Card title="Discussions" icon="comments" href="https://github.com/votre-org/kitasso/discussions">
